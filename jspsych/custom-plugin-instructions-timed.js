...
var jsPsychInstructionsTimed = (function (jspsych) {
  'use strict';

  const info = {
      name: "instructions-timed",
      parameters: {
          ...
          /** The text that appears on the button to continue. */
          button_label_continue: {
              type: jspsych.ParameterType.STRING,
              pretty_name: "Button label continue",
              default: "Continue",
          },
          /** The text that appears above the continue button. */
          instructions_text: {
              type: jspsych.ParameterType.STRING,
